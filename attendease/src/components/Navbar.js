  ...
  return (
    ...
    <nav id="nav">
      <div class="nav left">
        ...
        <div   class="nav-link "to="/home"><span class="nav-link-span"><span class="u-nav"><img src="./yuy.png"/></span></span></div>
        <button id="menu" class="btn-nav"><span class="fas fa-bars"></span></button>
      </div>
      <div class="nav right">
      <Link   class="nav-link "to="/home"><span class="nav-link-span"><span class="u-nav">Home</span></span></Link>
